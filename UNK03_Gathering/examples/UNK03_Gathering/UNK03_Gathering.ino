...
void setup() {
  ...
  //_________________สำหรับตั้งค่าองศาเซอร์โว_________________
  setUpDown(150, 65);       //ตั้งค่าเซอร์โว setUpDown(ขึ้น,ลง);
  setOpen(100, 100);        //ค่าตำแหน่งเซอร์โว ซ้ายขวา ตอนกาง
  setCloseSmall(100, 100);  //ค่าเซอร์โว ซ้ายขวา หุบลูกเล็ก
  setCloseBig(100, 100);    //ค่าเซอร์โว ซ้ายขวา หุบลูกใหญ่
  ...
  Servo(-1, -1, -1);  //ตั้งค่าเซอร์โวไม่ให้ล็อค
